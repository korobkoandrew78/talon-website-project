...
def handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    ...
    успех либо причину отказа с разными HTTP-кодами: 400 не указан idx / балансная карта, 404 карта/АЗС
    не найдена, 423 карта заблокирована, 402 недостаточно топлива, 429 превышен дневной лимит.
