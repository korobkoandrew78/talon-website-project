...
def handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    ...
    Данные сгруппированы по организации (ИНН), виду топлива (код 1С) и цене продажи — количество
    и сумма за период, готовые для создания документов "Реализация товаров и услуг". Если один вид
    топлива продавался по разным ценам — по каждой цене отдельная строка.
    ...
    try:
        ...
        cur.execute(
            ...
            "ft.code1c AS code1c, o.fuel_name AS fuel_name, ft.unit AS unit, o.price AS price, "
            ...
            "GROUP BY c.inn, o.client_name, ft.code1c, o.fuel_name, ft.unit, o.price "
            "ORDER BY c.inn, ft.code1c, o.price",
