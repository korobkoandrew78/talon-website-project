...
// Фиксируются операции с движением топлива, а также ручное изменение баланса
// менеджером при редактировании карты. Блокировка/разблокировка/создание/
// удаление карт в журнал не попадают.
