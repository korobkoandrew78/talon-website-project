...
// Фиксируются операции с движением топлива, а также ручные изменения карты
// менеджером (баланс, вид топлива, цена) при её редактировании. Блокировка/
// разблокировка/создание/удаление карт в журнал не попадают.
...
export const OPERATION_LABELS: Record<OperationType, string> = {
  ...
  balance_edit: 'Изменение менеджером',
};
